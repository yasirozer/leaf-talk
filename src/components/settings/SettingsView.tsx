      ...
      <div className="max-w-lg mx-auto py-10 px-4 space-y-6">
        ...
        {isCustom && (
          <div className="p-5 rounded-2xl bg-secondary/50 border border-border space-y-3">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-card border border-border text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-dim"
            />
        ...
        <div className="p-5 rounded-2xl bg-secondary/50 border border-border space-y-3">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl bg-card border border-border text-sm focus:outline-none focus:ring-1 focus:ring-primary placeholder:text-dim"
          />
